  ...
  return new Promise(function (resolve, reject) {
    const doctors = Array.from(
      ...
      (x, i) => ({
        ...
        yearsOfExperience: faker.datatype.number({ min: 0, max: 50 }),
...
exports.doctorFeedbackGET = function (name, specialty, expirience) {
  return new Promise(function (resolve, reject) {
    const doctors = Array.from(
...
exports.doctorFeedbackPOST = function (name, specialty, expirience) {
  return new Promise(function (resolve, reject) {
    resolve();
  });
};

exports.doctorDetailsGET = function (name, specialty, expirience) {
  return new Promise(function (resolve, reject) {
    debugger;
